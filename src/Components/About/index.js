            ...
            <div className="flex w-4/5 xl:w-full md:justify-center overflow-hidden">
                <div
                    ...
                    <div className="ml-5 text-lg tracking-wide xl:text-base">
                        <p className="mt-12">
                            - Learn, accumulate more experience, knowledge, and
                            practice skills to increase accuracy
                        </p>
                        <p className="mt-12">
                            - Provide the most satisfactory value for the
                            company and customers.
                        </p>
                        <p className="mt-12">
                            - Always try to improve my level to become an
                            excellent employee in my field field.
                        </p>
                        <p className="mt-12">
                            - Have a stable job that provides me the capability
                            to learn new things, technologies, and skills to
                            achieve any task the company assigns to me or I have
