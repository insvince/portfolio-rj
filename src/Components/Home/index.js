...
function Home() {
  return (
    <div
      className="reveal flex justify-center relative h-[550px] sm:mb-12 sm:flex-col"
      id="home"
    >
      <div className="flex justify-evenly items-center w-4/5 xl:w-[95%] md:w-[100%] ">
        ...
        <div className="flex justify-around items-center flex-1 sm:flex-col">
          <div className="w-2/5 flex justify-center overflow-hidden sm:mt-[50px]">
            <img
              className="h-[300px] hover:scale-110 duration-500 animate-swimming lg:h-[220px] md:h-[160px] sm:h-[220px] "
          ...
          <div className="w-3/5 flex flex-col justify-center items-center  animate-translateXReverse duration-500 md:w-full">
            <h1
              className="typing text-4xl font-bold mb-5 h-[80px] w-[460px] duration-500 xl:text-3xl lg:w-[400px] md:w-[85%] sm:text-center"
              aria-hidden="true"
            />
            <p className="mt-5 w-[460px] text-lg duration-500 xl:text-base xl:w-[400px] md:w-[80%]">
