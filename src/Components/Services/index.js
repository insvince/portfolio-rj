...
function Services() {
  return (
    <div
      ...
      id="services"
    >
      <div className="absolute text-4xl font-bold top-[50%]">Coming Soon</div>
      <div className="w-3/4 ">
        <h2 className="text-4xl font-bold underline text-center mb-12 mt-12">
          Services
        </h2>
        <div className="flex justify-evenly items-center ">
          <div className="text-center bg-gradient-to-br to-blue-600 from-cyan-500 rounded-2xl h-[450px] text-black w-[30%] flex flex-col justify-start items-center  opacity-30">
            <img
