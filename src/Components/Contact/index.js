...
function Contact({ status, idComponent }) {
    return (
        <div
            className=" reveal flex justify-center h-[700px] p-12 overflow-hidden sm:p-2"
            id={idComponent}>
            <div className="w-3/4 xl:w-full">
                ...
                <div className="flex justify-between items-start md:flex-col-reverse md:items-center md:mb-16">
                    <div
                        ...
                        <div className="mt-5">
                            Please fill in the information and I'll reply to
                            your message as soon as possible, wellcome back to
                            my website.
                        </div>
                        <div className="mt-5 flex flex-col justify-between h-[220px]">
                            ...
                            <div>
                                ...
                                <span className="font-semibold text-lg ml-5 xl:text-base">
                                    <a
                                        href="mailto:phuochuy1328@gmail.com"
                                        rel="noreferrer">
